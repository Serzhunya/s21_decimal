...
END_TEST
START_TEST(
    s21_test_decimal_sub_simple_5) {  // роботает только с ппервым массивом -
                                      // ложный результат
  ...
  s21_decimal d = {0b11111111111111111111111111111111, 0, 0, 0};
  s21_decimal etalon = {0b00000000000000000000000000000000,
                        0b01111111111111111111111111111111, 0, 0};
