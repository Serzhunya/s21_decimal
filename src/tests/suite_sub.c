...
START_TEST(s21_test_decimal_sub_simple_0) {  // 10 -5 =5
    ...
    int add = s21_decimal_sub_simple(c, d, p_res);
...
START_TEST(s21_test_decimal_sub_simple_3) {  // роботает только с ппервым массивом - ложный результат
...
START_TEST(s21_test_decimal_sub_simple_4) {  // роботает только с ппервым массивом - ложный результат

    s21_decimal c = {0b11111111111111111111111111111111, 0, 0, 0};
    s21_decimal d = {0b11111111111111111111111111111111, 0, 0, 0};
...
END_TEST
START_TEST(s21_test_decimal_sub_simple_5) {  // роботает только с ппервым массивом - ложный результат
                                             // 1111111111111111111111111111111100000000000000000000000000000000 - 11111111111111111111111111111111
                                             // 111111111111111111111111111111100000000000000000000000000000000
    s21_decimal c = {0, 0b11111111111111111111111111111111, 0, 0};
    s21_decimal d = {0b11111111111111111111111111111111, 0, 0, 0};
    s21_decimal etalon = {0b00000000000000000000000000000000, 0b01111111111111111111111111111111, 0, 0};
...
START_TEST(s21_test_decimal_sub_simple_6) {  // 1-1=0
...
// START_TEST(s21_test_decimal_sub_simple_12) {  // -1-(-1)=0
//     s21_decimal c = {100, 0, 0, ~(INT_MAX)};
//     s21_decimal d = {100, 0, 0, ~(INT_MAX)};
//     s21_decimal etalon = {0, 0, 0, 0};
