...
// Функции для транкейт
int division_in_10(s21_decimal value_1,
                   s21_decimal *result);  // возвращает код ошибки
s21_decimal division_in_10_logic(s21_decimal value_1, s21_decimal *result,
                                 int *code);  // возвращает децимал
...
int division_in_10(s21_decimal value_1, s21_decimal *result) {
  int code = 0;
  division_in_10_logic(value_1, result, &code);
  return code;
}
...
int truncate(s21_decimal value, s21_decimal *result) {
  ...
  s21_decimal copy = {0};
  copy.bits[0] = 0b00000000000000000000000000000000;  // 0
  copy.bits[1] = 0b00000000000000000000000000000000;
  copy.bits[2] = 0b00000000000000000000000000000000;
  copy.bits[3] = 0b00000000000000000000000000000000;
  for (int i = 0; i < 3; i++) {
    for (int j = 0; j < 32; j++) {
  ...
  while (exp--) {
    memset(result, 0, sizeof(*result));
    res_value = division_in_10_logic(copy, result, &code);
    copy = res_value;
  }
  *result = res_value;
  return 0;
...
int main(void) {
  s21_decimal dec1;
  s21_decimal result;
  dec1.bits[0] = 0b00000111111111111111111111111111;  // 409.5
  dec1.bits[1] = 0b00000000000000000000000000000000;
  dec1.bits[2] = 0b00000000000000000000000000000000;
  dec1.bits[3] = 0b00000000000000110000000000000000;  // 1
  print_2(&dec1);
